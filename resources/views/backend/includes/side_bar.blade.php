...
<nav class="side-bar no-print">
    ...
    <div class="side-bar-manu">
        <ul>
            @if (auth()->user()->can('browse_dashboard') ||
                    ...
                    <li class="@if (Request::is('admin/products', 'admin/products/*', 'admin/categories', 'admin/categories/*', 'admin/brands', 'admin/brands/*')) active @endif">
                        ...
                        <ul>
                            @if(auth()->user()->can('browse_products') || auth()->user()->hasRole('super-admin'))
                                <li>
                                    <a class="@if(Request::is('admin/products','admin/products/*/edit'))active @endif"
                                       href="{{route('backend.products.index')}}">{{ __('All Comic Book') }}
                                    </a>
                                </li>
                            @endif
                            @if(auth()->user()->can('create_products') || auth()->user()->hasRole('super-admin'))
                            <li>
                                <a class="@if(Request::is('admin/products/admin-custom-product'))active @endif"
                                   href="{{route('backend.products.create-custom-product')}}">{{__('Add Book')}}</a>
                            </li>
                            @endif
                            ...
                            @if(auth()->user()->can('browse_brands') || auth()->user()->hasRole('super-admin'))
                                <li><a class="@if(Request::is('admin/brands','seller/brands/*/edit'))active @endif"
